(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HeaderComponent = /** @class */ (function () {
                function HeaderComponent(router, storage) {
                    this.router = router;
                ...
                HeaderComponent.prototype.newAd = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AdDetailsComponent = /** @class */ (function () {
                function AdDetailsComponent(productService, route) {
                ...
                AdDetailsComponent.prototype.ngOnInit = function () {
                    ...
                    this.productService.product(this.id)
                        ...
                        _this.product = JSON.parse(JSON.stringify(data)).product;
                        console.log(_this.product);
                    });
                };
                return AdDetailsComponent;
            }());
            AdDetailsComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddComponent = /** @class */ (function () {
                function AddComponent(productService, storage, router, route) {
                    this.productService = productService;
                    this.storage = storage;
                    this.router = router;
                    this.route = route;
                ...
                AddComponent.prototype.isEmpty = function (obj) {
                    for (var key in obj) {
                ...
                AddComponent.prototype.AddProduct = function (product) {
                    var _this = this;
                ...
                AddComponent.prototype.selectChangeHandlerItem = function (event) {
                    this.category = event.target.value;
                };
                AddComponent.prototype.selectChangeHandlerAge = function (event) {
                    this.age = event.target.value;
                };
                AddComponent.prototype.selectChangeHandlerUsage = function (event) {
                    this.usage = event.target.value;
                };
                AddComponent.prototype.selectChangeHandlerCondition = function (event) {
                    this.condition = event.target.value;
                };
                AddComponent.prototype.selectChangeHandlerLocation = function (event) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AllAdsComponent = /** @class */ (function () {
                function AllAdsComponent(productService, router, storage) {
                    this.productService = productService;
                    this.router = router;
                    this.storage = storage;
                    this.admin = false;
                ...
                AllAdsComponent.prototype.isEmpty = function (obj) {
                    for (var key in obj) {
                        if (obj.hasOwnProperty(key))
                            return true;
                    }
                ...
                AllAdsComponent.prototype.products = function (category) {
                    var _this = this;
                ...
                AllAdsComponent.prototype.selectChangeHandlerItem = function (event) {
                    this.category = event.target.value;
                    console.log(this.category);
                };
                AllAdsComponent.prototype.delete = function (id) {
                    var _this = this;
                    // alert("delete!")
                ...
                AllAdsComponent.prototype.productDetail = function (id) {
                    if (this.storage.get('uname') == null)
                        this.router.navigate(['login']);
                    else {
            ...
            AllAdsComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HomeComponent = /** @class */ (function () {
                function HomeComponent(productService, router, storage) {
                    this.productService = productService;
                    this.router = router;
                    this.storage = storage;
                    this.category = '';
                ...
                HomeComponent.prototype.isEmpty = function (obj) {
                    for (var key in obj) {
                        if (obj.hasOwnProperty(key))
                            return true;
                    }
                ...
                HomeComponent.prototype.products = function (category) {
                    var _this = this;
                    if (!this.isEmpty(category)) {
                        this.productService.random()
                            .subscribe(function (data) {
                ...
                HomeComponent.prototype.productDetail = function (id) {
                    if (this.storage.get('uname') == null)
                        this.router.navigate(['login']);
                    else {
                        this.id = this.productService.setId(id);
                ...
                HomeComponent.prototype.selectChangeHandlerItem = function (event) {
                    this.category = event.target.value;
                    console.log(this.category);
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function () {
                function LoginComponent(storage, productService, router) {
                    this.storage = storage;
                    this.productService = productService;
                    this.router = router;
                    this.model = {};
                ...
                LoginComponent.prototype.onSubmit = function () {
                    ...
                    this.productService.login(this.model)
                        .subscribe(function (result) {
                        _this.Status = JSON.parse(JSON.stringify(result)).Status;
                        if (_this.Status == "Success") {
                            _this.storage.set('uname', _this.model.email);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var IProduct = /** @class */ (function () {
                function IProduct(category, title, phone, price, description, age, usage, condition, location, email, image) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var angular_webstorage_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! angular-webstorage-service */ "./node_modules/angular-webstorage-service/bundles/angular-webstorage-service.js");
            var __dirname = "C:\Users\WORK\Desktop\ProjectFinal\projectApp";
            var ProductService = /** @class */ (function () {
                function ProductService(http, storage) {
                    this.http = http;
                    this.storage = storage;
                }
                ProductService.prototype.setId = function (id) {
                    this.storage.set('id', id);
                };
                ProductService.prototype.getId = function () {
                    return this.storage.get('id');
                };
                ProductService.prototype.login = function (user) {
                    return this.http.post("http://localhost:8080/login", user);
                };
                ProductService.prototype.signup = function (user) {
                    return this.http.post("http://localhost:8080/signup", user);
                };
                ProductService.prototype.users = function () {
                    return this.http.get("http://localhost:8080/signup/users");
                };
                ProductService.prototype.deleteUser = function (email) {
                    return this.http.post("http://localhost:8080/signup/delete", { email: email });
                };
                ProductService.prototype.products = function (category) {
                ...
                ProductService.prototype.setUser = function (email) {
                    this.storage.set('email', email);
                };
                ProductService.prototype.getUser = function (user) {
                    return this.http.post("http://localhost:8080/signup/profile", { email: user });
                };
                ProductService.prototype.getAds = function (user) {
                ...
                ProductService.prototype.random = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProfileComponent = /** @class */ (function () {
                function ProfileComponent(storage, route, productService, router) {
                    this.storage = storage;
                    this.route = route;
                    this.productService = productService;
                    this.router = router;
                ...
                ProfileComponent.prototype.ngOnInit = function () {
                    ...
                    this.productService.getUser(this.uname)
                        .subscribe(function (data) {
                        _this.user = JSON.parse(JSON.stringify(data)).user;
                ...
                ProfileComponent.prototype.viewAds = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SignupComponent = /** @class */ (function () {
                function SignupComponent(router, storage, productService, http) {
                    this.router = router;
                    this.storage = storage;
                    this.productService = productService;
                    this.http = http;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var Signup = /** @class */ (function () {
                function Signup(fname, lname, email, passwsord, confirmPassword, dp, phone) {
                    this.fname = fname;
                    this.lname = lname;
                    this.email = email;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UsersComponent = /** @class */ (function () {
                function UsersComponent(productService, router, storage) {
                    this.productService = productService;
                    this.router = router;
                    this.storage = storage;
                    this.admin = false;
                ...
                UsersComponent.prototype.userDetails = function (email) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ViewAdsComponent = /** @class */ (function () {
                function ViewAdsComponent(storage, router, productService) {
                    this.storage = storage;
                    this.router = router;
                    this.productService = productService;
                    this.admin = false;
                ...
                ViewAdsComponent.prototype.edit = function (product) {
                    this.router.navigate(['add', product]);
                };
                ViewAdsComponent.prototype.delete = function (id) {
                    var _this = this;
                    this.productService.delete(id)
                        .subscribe(function (result) {
                        if (JSON.parse(JSON.stringify(result)).Status == "Success") {
            ...
            ViewAdsComponent.ctorParameters = function () { return [
                { type: angular_webstorage_service__WEBPACK_IMPORTED_MODULE_2__["WebStorageService"], decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [angular_webstorage_service__WEBPACK_IMPORTED_MODULE_2__["LOCAL_STORAGE"],] }] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
                { type: _product_service__WEBPACK_IMPORTED_MODULE_4__["ProductService"] }
            ]; };
